...
\caption{\label{tab:topModels}The fixed effects and summary statistics for top models for each species.}
\centering
\resizebox{\linewidth}{!}{
...
\begin{figure}[htb]
\includegraphics[width=1\linewidth,]{../3_output/figures/timelag_stats/sppAll_AUC_lm} \caption{The relationship between AUC and LiDAR temporal misalignment with bird surveys for each species.}\label{fig:AUCLag}
\end{figure}
