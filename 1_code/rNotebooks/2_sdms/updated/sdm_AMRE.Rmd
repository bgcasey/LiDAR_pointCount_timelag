...
#models
md_0<-lme4::glmer(AMRE_OCC ~ ndvi_lag_0 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(AMRE_OCC ~ ndvi_lag_1 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(AMRE_OCC ~ ndvi_lag_2 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(AMRE_OCC ~ ndvi_lag_3 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(AMRE_OCC ~ ndvi_lag_4 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(AMRE_OCC ~ ndvi_lag_5 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(AMRE_OCC ~ ndvi_lag_6 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(AMRE_OCC ~ ndvi_lag_7 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(AMRE_OCC ~ ndvi_lag_8 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(AMRE_OCC ~ ndvi_lag_9 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(AMRE_OCC ~ ndvi_lag_10 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(AMRE_OCC ~ ndvi_lag_11 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(AMRE_OCC ~ ndvi_lag_12 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(AMRE_OCC ~ ndvi_lag_13 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(AMRE_OCC ~ ndvi_lag_14 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(AMRE_OCC ~ ndvi_lag_15 +  elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum +  elev_p50 + forest_age_class_r + (1|SS) , data=dd, family = binomial, offset = AMRE_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
sw<-cbind(AMRE_models_AUC_4, Year)%>%
  left_join(ERA5)
...
auc_3<-lm(AUC_mean~ lag + as.numeric(scale(AMRE_OCC)), data=swx)
auc_4<-lm(AUC_mean~ AMRE_OCC, data=swx)
...
AUC_cor_test <- cor.test(AMRE_models_AUC_4$AUC_mean, AMRE_models_AUC_4$lag, method = "pearson")
