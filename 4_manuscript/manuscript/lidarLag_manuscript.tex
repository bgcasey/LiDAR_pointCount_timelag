...
\begin{figure}[htb]
\includegraphics[width=1\linewidth,]{../3_output/figures/timelag_stats/sppAll_AUC_lm} \end{figure}
...
\begin{figure}[!ht]
\includegraphics[width=1\linewidth,]{../3_output/figures/timelag_stats/spp_scatter_00to15} \end{figure}
...
\begin{figure}[!ht]
\includegraphics[width=1\linewidth,]{../3_output/figures/timelag_stats/sppAll_FADIF_lm} \end{figure}
