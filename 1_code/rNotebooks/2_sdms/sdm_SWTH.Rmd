...
```{r eval=FALSE}
SWTH_m0<-glm(SWTH ~ 1, data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

SWTH_m1<-lme4::glmer(SWTH_OCC ~ 1 + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

SWTH_m2<-lme4::glmer(SWTH ~ 1 + (1|SS) + (1|ss_year), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

SWTH_m3<-lme4::glmer(SWTH ~ 1 + (1|ss_year/SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

# # Compare models
anova(SWTH_m3, SWTH_m1)
...
```{r eval=FALSE}
cm1<-lme4::glmer(SWTH ~ rast_forest_age  + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude )

cm2<-lme4::glmer(SWTH ~  LCC4 + (1|ss_year/SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude )

cm3<-lme4::glmer(SWTH ~  LCC4 + LCC2 + rast_forest_age + Forest_Type + (1|ss_year/SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

cm4<-lme4::glmer(SWTH ~ poly_forest_age  + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude )
...
# rast_forest_age
mp1<-lme4::glmer(SWTH ~rast_forest_age + (1 | SS), data=d, subset=SS_lidar_timelag==0, family = binomial, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

 
mp2<-lme4::glmer(SWTH ~ poly(rast_forest_age,2) + (1 | SS), data=d, subset=SS_lidar_timelag==0, family = binomial, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

mp3<-lme4::glmer(SWTH ~poly(rast_forest_age,3) + (1 | SS), data=d, subset=SS_lidar_timelag==0, family = binomial, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

mp4<-lme4::glmer(SWTH ~poly(rast_forest_age,4) + (1 | SS), data=d, subset=SS_lidar_timelag==0, family = binomial, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 
...
plm2<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_cv+ elev_maximum + elev_mean+   elev_p50 +  elev_p95 + elev_stddev+ percentage_first_returns_above_mean+ total_all_returns +  elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

l_vif<-as.data.frame(vif(plm2))

plm3<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_cv+ elev_maximum +   elev_p50 +  elev_p95 + elev_stddev+ percentage_first_returns_above_mean+ total_all_returns +  elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

l_vif<-as.data.frame(vif(plm3))


plm4<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum +   elev_p50 +  elev_p95 + elev_stddev+ percentage_first_returns_above_mean+ total_all_returns +  elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.exclude)

l_vif<-as.data.frame(vif(plm4))



plm5<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum +   elev_p50  + elev_stddev+ percentage_first_returns_above_mean+ total_all_returns +  elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.fail)
...
SWTH_can<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + percentage_first_returns_above_mean+ total_all_returns +  elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.fail)
...
m1<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = SWTH_OFF,  na.action = na.fail)
...
# m1: SWTH_OCC ~ canopy_relief_ratio + elev_maximum * elev_stddev + elev_p50 + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1 | SS)
#         npar    AIC    BIC  logLik deviance  Chisq Df Pr(>Chisq)    
# SWTH_m1    2 458.12 465.80 -227.06   454.12                         
...
#models
md_0<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(SWTH_OCC ~  canopy_relief_ratio+ elev_maximum  * elev_stddev +   elev_p50  + elev_0pnt15_to_2pnt00_return_proportion + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
