...
writeRaster(AMRE_predictMap_m_0,file="3_output/maps/predictedDistributions/AMRE/AMRE_predictMap_m_0", format="GTiff", overwrite=T)
##########################
dd<-sdm_d%>%filter(SS_lidar_timelag==-1)
...
#models
md_0<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
writeRaster(WIWR_predictMap_m_0,file="3_output/maps/predictedDistributions/WIWR/WIWR_predictMap_m_0", format="GTiff", overwrite=T)
##########################
dd<-sdm_d%>%filter(SS_lidar_timelag==-1)
...
md_1<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
writeRaster(WTSP_predictMap_m_0,file="3_output/maps/predictedDistributions/WTSP/WTSP_predictMap_m_0", format="GTiff", overwrite=T)
##########################
dd<-sdm_d%>%filter(SS_lidar_timelag==-1)
...
#models
md_0<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
