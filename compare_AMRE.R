...
AMRE_fa_co_df<-as.data.frame(na.omit(values(fa_co)))%>%
  dplyr::rename(forest_age=lidar_forestAge_raster)
          
save(AMRE_fa_co_df, file="2_pipeline/store/AMRE_fa_co_df.rData")
...
############### Plot Effect ######################################################
#######################################################################################
lm_fa_00to01 <- lm(predCor_0_01 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to01, terms="forest_age [all]", data=AMRE_fa_co_df)
...
t<-ggpredict(lm_fa_00to02, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to03 <- lm(predCor_0_03 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to03, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to04 <- lm(predCor_0_04 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to04, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to05 <- lm(predCor_0_05 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to05, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to06 <- lm(predCor_0_06 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to06, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to07 <- lm(predCor_0_07 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to07, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to08 <- lm(predCor_0_08 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to08, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to09 <- lm(predCor_0_09 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to09, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to10 <- lm(predCor_0_10 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to10, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to11 <- lm(predCor_0_11 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to11, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to12 <- lm(predCor_0_12 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to12, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to13 <- lm(predCor_0_13 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to13, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to14 <- lm(predCor_0_14 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to14, terms="forest_age [all]", data=AMRE_fa_co_df)
...
dev.off()
#######################################################################################
lm_fa_00to15 <- lm(predCor_0_15 ~ forest_age, data=AMRE_fa_co_df)
t<-ggpredict(lm_fa_00to15, terms="forest_age [all]", data=AMRE_fa_co_df)
