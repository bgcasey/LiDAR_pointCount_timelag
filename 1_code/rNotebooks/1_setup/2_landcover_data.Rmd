...
c_bb_tr<-st_transform(c_bb, st_crs(cas_geo))
cas_geo_clip<-st_intersection(cas_geo, c_bb_tr)
cas_geo_clip_tr<-st_transform(cas_geo_clip, st_crs(c_bb))

save(cas_geo_clip, file="0_data/manual/spatialCov/CASFRI/cas_geo_clip.rData")
...
```{r eval=FALSE}
pkey_cas_cov$forest_age<-pkey_cas_cov$ss_year-pkey_cas_cov$origin_upper
```
