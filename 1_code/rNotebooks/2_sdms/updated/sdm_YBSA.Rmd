...
YBSA_AUC_lm_test_2<-lm(AUC_mean~ poly(lag, 2), data=YBSA_models_AUC_4)
summary(YBSA_AUC_lm_test_2)



YBSA_AUC_lm_test_3<-lm(log(AUC_mean) ~ lag, data=YBSA_models_AUC_4)
summary(YBSA_AUC_lm_test_3)


fit <- nls(AUC_mean ~ SSasymp(t, lag, log_alpha), data = YBSA_models_AUC_4)
fit

YBSA_AUC_lm_test_2<-nls(AUC_mean ~ exp(a + b * lag), data=YBSA_models_AUC_4, start = list(a = 0, b = 0))
summary(YBSA_AUC_lm_test_2)
...
sw<-cbind(YBSA_models_AUC_4, Year)%>%
  left_join(ERA5)
...
auc_3<-lm(AUC_mean~ lag + as.numeric(scale(YBSA_OCC)), data=swx)
auc_4<-lm(AUC_mean~ YBSA_OCC, data=swx)
...
AUC_cor_test <- cor.test(YBSA_models_AUC_4$AUC_mean, YBSA_models_AUC_4$lag, method = "pearson")
...
#models
md_0<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(YBSA_OCC ~elev_4pnt00_to_6pnt00_return_proportion+  elev_maximum*elev_stddev+(1|SS) , data=dd, family = binomial, offset = YBSA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
