...
m1<-lme4::glmer(BTNW_OCC ~  canopy_relief_ratio + elev_maximum + total_all_returns +  (1|SS), data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.fail ) 
...
#models
md_0<-lme4::glmer(BTNW_OCC ~ ndvi_lag_0 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(BTNW_OCC ~ ndvi_lag_1 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(BTNW_OCC ~ ndvi_lag_2 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(BTNW_OCC ~ ndvi_lag_3 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(BTNW_OCC ~ ndvi_lag_4 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(BTNW_OCC ~ ndvi_lag_5 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(BTNW_OCC ~ ndvi_lag_6 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(BTNW_OCC ~ ndvi_lag_7 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(BTNW_OCC ~ ndvi_lag_8 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(BTNW_OCC ~ ndvi_lag_9 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(BTNW_OCC ~ ndvi_lag_10 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(BTNW_OCC ~ ndvi_lag_11 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(BTNW_OCC ~ ndvi_lag_12 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(BTNW_OCC ~ ndvi_lag_13 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(BTNW_OCC ~ ndvi_lag_14 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(BTNW_OCC ~ ndvi_lag_15 + canopy_relief_ratio + elev_maximum + elev_cv +  total_all_returns +(1|SS) , data=dd, family = binomial, offset = BTNW_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
