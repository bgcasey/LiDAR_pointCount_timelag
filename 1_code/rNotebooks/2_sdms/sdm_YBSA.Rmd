...
YBSA_can<-lme4::glmer(YBSA_OCC  ~ elev_0pnt15_to_2pnt00_return_proportion +elev_2pnt00_to_4pnt00_return_proportion+percentage_first_returns_above_2pnt00+elev_maximum + elev_stddev +elev_p50  +percentage_first_returns_above_2pnt00 +percentage_first_returns_above_mean  +total_all_returns +  (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = YBSA_OFF,  na.action = na.fail)
...
m1<-lme4::glmer(YBSA_OCC ~ elev_0pnt15_to_2pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = YBSA_OFF,  na.action = na.fail)
