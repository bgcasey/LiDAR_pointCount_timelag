...
m1<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev  + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = WIWR_OFF,  na.action = na.fail)

# m2<-lme4::glmer(WIWR_OCC ~  elev_maximum * elev_stddev + total_all_returns + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = WIWR_OFF,  na.action = na.fail)
# 
# m3<-lme4::glmer(WIWR_OCC ~  elev_maximum + elev_stddev + total_all_returns + elev_2pnt00_to_4pnt00_return_proportion + (1|SS), data=d, subset=SS_lidar_timelag==0, family = binomial, offset = WIWR_OFF,  na.action = na.fail)
