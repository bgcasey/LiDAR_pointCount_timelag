...
WIWR_AUC_lm_test_2<-lm(AUC_mean~ lag, 2), data=WIWR_models_AUC_4)
summary(WIWR_AUC_lm_test_2)



WIWR_AUC_lm_test_3<-lm(log(AUC_mean) ~ lag, data=WIWR_models_AUC_4)
summary(WIWR_AUC_lm_test_3)



WIWR_AUC_lm_test_2<-nls(AUC_mean ~ exp(a + b * lag), data=WIWR_models_AUC_4, start = list(a = 0, b = 0))
summary(WIWR_AUC_lm_test_2)
...
sw<-cbind(WIWR_models_AUC_4, Year)%>%
  left_join(ERA5)
...
auc_3<-lm(AUC_mean~ lag + as.numeric(scale(WIWR_OCC)), data=swx)
auc_4<-lm(AUC_mean~ WIWR_OCC, data=swx)
...
AUC_cor_test <- cor.test(WIWR_models_AUC_4$AUC_mean, WIWR_models_AUC_4$lag, method = "pearson")
...
WIWR_auc_boot_all<-rbind(all_md_0, all_md_1, all_md_2, all_md_3, all_md_4, all_md_5, all_md_6, all_md_7, all_md_8, all_md_9, all_md_10, all_md_11, all_md_12, all_md_13, all_md_14, all_md_15)

save(WIWR_auc_boot_all, file="2_pipeline/store/models/WIWR_auc_boot_all.rData")


WIWR_auc_boot_all_lm<-lm(AUC~ lag, data=all_md_AUC)
...
#models
md_0<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(WIWR_OCC ~ canopy_relief_ratio+ elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum +   percentage_first_returns_above_mean+(1|SS) , data=dd, family = binomial, offset = WIWR_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
WIWR_AUC_lm_test_2<-lm(AUC_mean~ poly(lag, 2), data=WIWR_models_AUC_4)
summary(WIWR_AUC_lm_test_2)
...
fit <- nls(AUC_mean ~ SSasymp(t, lag, log_alpha), data = WIWR_models_AUC_4)
fit
...
md_15_t<-as.data.frame(md_15_bootAUC$t[,3])
md_15_t$lag<-15
