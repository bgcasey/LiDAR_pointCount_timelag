...
#d3<-d3%>%filter(lidar_year==2009)
# 
# 
# d3ab<-d3%>%filter(SS_lidar_timelag==0)%>%
...
```{r eval=FALSE}
MOWA_m0<-glm(MOWA_OCC ~ 1, data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude)

MOWA_m1<-lme4::glmer(MOWA_OCC ~ 1 + (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude)

MOWA_m2<-lme4::glmer(MOWA_OCC ~ 1 + (1|SS) + (1|ss_year), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude)

MOWA_m3<-lme4::glmer(MOWA_OCC ~ 1 + (1|ss_year/SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude)

# # Compare models
anova(MOWA_m2, MOWA_m1)
...
plm1<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 + canopy_relief_ratio+  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_4pnt00_to_6pnt00_return_proportion+  elev_below_0pnt15_return_proportion+ elev_cv+ elev_maximum + elev_mean+ elev_p50 + elev_p95 + elev_p99 + elev_stddev+ percentage_first_returns_above_2pnt00+ percentage_first_returns_above_mean+ total_all_returns +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 
...
plm2<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 + canopy_relief_ratio+  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_4pnt00_to_6pnt00_return_proportion+  elev_cv+ elev_maximum + elev_mean+ elev_p50 + elev_p95 + elev_p99 + elev_stddev+  percentage_first_returns_above_mean+ total_all_returns +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 

l_vif<-as.data.frame(vif(plm2))

plm3<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum + elev_mean+ elev_p50 + elev_p95 + elev_p99 + elev_stddev+  percentage_first_returns_above_mean+ total_all_returns +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 

l_vif<-as.data.frame(vif(plm3))

plm4<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum + elev_mean+ elev_p50 + elev_p95  + elev_stddev+  percentage_first_returns_above_mean+  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 

l_vif<-as.data.frame(vif(plm4))



plm5<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion +  elev_cv+ elev_maximum + elev_mean+ elev_p50 + elev_stddev+  percentage_first_returns_above_mean+  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 

l_vif<-as.data.frame(vif(plm5))

plm6<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum + elev_stddev+ elev_mean+ elev_p50 +  percentage_first_returns_above_mean+  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 
...
plm7<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 + elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_4pnt00_to_6pnt00_return_proportion+  elev_stddev+ elev_maximum + elev_mean+ elev_p50   +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude )

l_vif<-as.data.frame(vif(plm7))
# 
plm8<-lme4::glmer(MOWA_OCC ~ ndvi_lag_0 + elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_4pnt00_to_6pnt00_return_proportion+  elev_stddev+ elev_maximum + elev_p50   +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude )

l_vif<-as.data.frame(vif(plm8))
# 
# plm8<-lme4::glmer(MOWA_OCC ~ + ndvi_2009 + elev_0pnt15_to_2pnt00_return_proportion+  elev_2pnt00_to_4pnt00_return_proportion  + elev_stddev+  percentage_first_returns_above_mean+ total_all_returns +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.exclude ) 
# 
# l_vif<-as.data.frame(vif(plm8))
# 
...
```{r eval=FALSE}
in_1<-lme4::glmer(MOWA_OCC ~ elev_maximum  * elev_stddev   +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action=na.fail) 
d_in_1<-MuMIn::dredge(in_1, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))


in_2<-lme4::glmer(MOWA_OCC ~ elev_maximum *  elev_0pnt15_to_2pnt00_return_proportion +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action=na.fail) 
d_in_2<-MuMIn::dredge(in_2, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))


# in_3<-lme4::glmer(MOWA_OCC ~ elev_maximum *  canopy_relief_ratio +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action=na.fail) 
# d_in_3<-MuMIn::dredge(in_3, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))


in_4<-lme4::glmer(MOWA_OCC ~ elev_maximum  * elev_p50    +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action=na.fail) 
d_in_4<-MuMIn::dredge(in_4, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))

in_5<-lme4::glmer(MOWA_OCC ~ elev_cv  :  elev_0pnt15_to_2pnt00_return_proportion    +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action=na.fail) 
...
nl1<-lme4::glmer(MOWA_OCC ~ndvi_lag_0 + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial,offset = MOWA_OFF, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

 
nl2<-lme4::glmer(MOWA_OCC ~ poly(ndvi_lag_0,2) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

nl3<-lme4::glmer(MOWA_OCC ~poly(ndvi_lag_0,3) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

nl4<-lme4::glmer(MOWA_OCC ~poly(ndvi_lag_0,4) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 
...
nl1<-lme4::glmer(MOWA_OCC ~rast_forest_age + (1 | SS), data=d, subset=SS_lidar_timelag==0, family = binomial,offset = MOWA_OFF, na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

 
nl2<-lme4::glmer(MOWA_OCC ~ poly(rast_forest_age,2) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

nl3<-lme4::glmer(MOWA_OCC ~poly(rast_forest_age,3) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 

nl4<-lme4::glmer(MOWA_OCC ~poly(rast_forest_age,4) + (1 | SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,na.action = na.exclude, control=glmerControl(optCtrl=list(maxfun=1e9))) 
...
``` {r eval=FALSE}
MOWA_can<-lme4::glmer(MOWA_OCC ~ poly(ndvi_lag_0,2)  +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+ elev_mean+ elev_p50 +  percentage_first_returns_above_mean+  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.fail ) 


MOWA_can_dredge<-MuMIn::dredge(MOWA_can, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))

MOWA_can_2<-lme4::glmer(MOWA_OCC ~ poly(ndvi_lag_0,2) +  elev_2pnt00_to_4pnt00_return_proportion + elev_4pnt00_to_6pnt00_return_proportion+ elev_maximum+ elev_maximum:elev_stddev  +  elev_p50+(1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.fail )

MOWA_can_dredge_2<-MuMIn::dredge(MOWA_can_2, extra = c(r2=function(x) round(r.squaredGLMM(x)[1,c(1,2)],3)))

save(MOWA_can_dredge, file="2_pipeline/store/models/MOWA_can_dredge.rData")
save(MOWA_can_dredge_2, file="2_pipeline/store/models/MOWA_can_dredge_2.rData")
...
print(MOWA_can_dredge_imp)
save(MOWA_can_dredge_imp, file="2_pipeline/store/models/MOWA_can_dredge_imp.rDATA")
```


```{r echo=FALSE, message = FALSE, results="asis"}
load("2_pipeline/store/models/MOWA_can_dredge.rData")

knitr::kable(MOWA_can_dredge) %>%
...
```{r echo=FALSE, message = FALSE, results="asis"}
load("2_pipeline/store/models/MOWA_can_dredge_imp.rData")

knitr::kable(head(MOWA_can_dredge_imp
                  )) %>%
  kable_styling(font_size = 10, bootstrap_options= c("striped", "hover", "condensed" ), full_width= F, position="center") %>%
  column_spec(1, width= "20em")%>%
  scroll_box(width = "100%", height = "400px")
...
# m1<-lme4::glmer(MOWA_OCC ~ ndvi_2009 + elev_2pnt00_to_4pnt00_return_proportion+  elev_cv+  elev_maximum + percentage_first_returns_above_2pnt00 +  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.fail ) 

m1<-lme4::glmer(MOWA_OCC ~ poly(ndvi_lag_0,2)  +  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=d3, subset=SS_lidar_timelag==0, family = binomial, offset = MOWA_OFF,  na.action = na.fail ) 
...
# m1: MOWA_OCC ~ ndvi_2009 + elev_2pnt00_to_4pnt00_return_proportion + elev_cv + elev_maximum + elev_p50 + (1 | SS)
#         npar    AIC    BIC  logLik deviance  Chisq Df Pr(>Chisq)    
# MOWA_m1    2 616.89 625.71 -306.45   612.89                         
...
MOWA_AUC_lm_test_2<-lm(AUC_mean~ poly(lag, 2), data=MOWA_models_AUC_4)
summary(MOWA_AUC_lm_test_2)



MOWA_AUC_lm_test_3<-lm(log(AUC_mean) ~ lag, data=MOWA_models_AUC_4)
summary(MOWA_AUC_lm_test_3)


fit <- nls(AUC_mean ~ SSasymp(t, lag, log_alpha), data = MOWA_models_AUC_4)
fit

MOWA_AUC_lm_test_2<-nls(AUC_mean ~ exp(a + b * lag), data=MOWA_models_AUC_4, start = list(a = 0, b = 0))
summary(MOWA_AUC_lm_test_2)
...
sw<-cbind(MOWA_models_AUC_4, Year)%>%
  left_join(ERA5)
...
auc_3<-lm(AUC_mean~ lag + as.numeric(scale(MOWA_OCC)), data=swx)
auc_4<-lm(AUC_mean~ MOWA_OCC, data=swx)
...
AUC_cor_test <- cor.test(MOWA_models_AUC_4$AUC_mean, MOWA_models_AUC_4$lag, method = "pearson")
...
dd<-sdm_d3%>%filter(SS_lidar_timelag==0)
...
#models
md_0<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))


md_0_bootAUC<-bootMer(md_0, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_0,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_00", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-1)
...
md_1<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_1_bootAUC<-bootMer(md_1, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_01,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_01", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-2)
...
md_2<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_2_bootAUC<-bootMer(md_2, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_02,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_02", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-3)
...
md_3<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_3_bootAUC<-bootMer(md_3, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_03,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_03", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-4)
...
md_4<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_4_bootAUC<-bootMer(md_4, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_04,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_04", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-5)
...
md_5<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_5_bootAUC<-bootMer(md_5, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_05,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_05", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-6)
...
md_6<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_6_bootAUC<-bootMer(md_6, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-7)
...
md_7<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_7_bootAUC<-bootMer(md_7, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_07,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_07", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-8)
...
md_8<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_8_bootAUC<-bootMer(md_8, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_08,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_08", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-9)
...
md_9<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_9_bootAUC<-bootMer(md_9, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-10)
...
md_10<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_10_bootAUC<-bootMer(md_10, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_10,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_10", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-11)
...
md_11<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_11_bootAUC<-bootMer(md_11, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_11,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_11", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-12)
...
md_12<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_12_bootAUC<-bootMer(md_12, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-13)
...
md_13<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_13_bootAUC<-bootMer(md_13, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_13,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_13", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-14)
...
md_14<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
 
md_14_bootAUC<-bootMer(md_14, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
#writeRaster(#MOWA_predictMap_m_14,file="3_output/maps/predictedDistributions/MOWA/#MOWA_predictMap_m_14", format="GTiff", overwrite=T)
##########################
dd<-sdm_d3%>%filter(SS_lidar_timelag==-15)
set.seed(1)
...
md_15<-lme4::glmer(MOWA_OCC ~  elev_0pnt15_to_2pnt00_return_proportion+ elev_2pnt00_to_4pnt00_return_proportion + elev_maximum *elev_stddev+   percentage_first_returns_above_mean+  (1|SS), data=dd, family = binomial, offset = MOWA_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )

md_15_bootAUC<-bootMer(md_15, nsim = 3, seed = 101, FUN=AUCFun,
        type = "parametric",
        verbose = TRUE, .progress = "none",
        use.u = TRUE)
...
MOWA_models_AUC_4b<-as.data.frame(rbind(md_0_meanAUC, md_1_meanAUC, md_2_meanAUC, md_3_meanAUC, md_4_meanAUC, md_5_meanAUC, md_6_meanAUC, md_7_meanAUC, md_8_meanAUC, md_9_meanAUC, md_10_meanAUC, md_11_meanAUC, md_12_meanAUC, md_13_meanAUC, md_14_meanAUC, md_15_meanAUC))%>%
  cbind(lag)
