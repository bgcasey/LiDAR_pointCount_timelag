\documentclass[manuscript, 3p,
authoryear]{elsarticle} %review=doublespace preprint=single 5p=2 column
%%% Begin My package additions %%%%%%%%%%%%%%%%%%%

\usepackage[hyphens]{url}

  \journal{Remote Sensing in Ecology and
Conservation} % Sets Journal name
...
\begin{frontmatter}
  ...
  \fnref{1}}
   ...
   \ead{bayne@ualberta.ca} 
      \affiliation[University of Alberta]{Department of Biological
Sciences, CW 405, Biological Sciences Bldg., Edmonton, AB, T6G 2E9}
