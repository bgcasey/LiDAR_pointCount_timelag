...
#models
md_0<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2009, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.fail, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)))
...
md_1<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2008, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_2<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2007, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_3<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2006, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_4<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2005, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_5<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2004, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_6<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2003, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_7<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2002, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_8<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2001, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_9<-lme4::glmer(SWTH_OCC ~ poly(ndvi_2000, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_10<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1999, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_11<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1998, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_12<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1997, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_13<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1996, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_14<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1995, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
md_15<-lme4::glmer(SWTH_OCC ~ poly(ndvi_1994, 2) +  elev_maximum + elev_p50 + (1|SS) , data=dd, family = binomial, offset = SWTH_OFF,  na.action = na.exclude, control=glmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e9)) )
...
# df<-tibble(year)
# 
# sw<-cbind(SWTH_models_AUC_4, Year)%>%
#   left_join(ERA5)
# 
# auc_0<-lm(AUC_mean~ lag, data=sw)
# auc_1<-lm(AUC_mean~ lag + total_precipitation, data=sw)
# auc_2<-lm(AUC_mean~ lag + maximum_2m_air_temperature, data=sw)
# auc_3<-lm(AUC_mean~ lag + mean_2m_air_temperature, data=sw)
# auc_3<-lm(AUC_mean~ mean_2m_air_temperature, data=sw)
# 
# 
# summary(auc_1)
...
AUC_cor_test <- cor.test(SWTH_models_AUC_4$AUC_mean, SWTH_models_AUC_4$lag, method = "pearson")
